...
import { type FaqTranslator, buildFaq } from "@/content/sections/faq"
...
export function Faq() {
  ...
  const faq = buildFaq(t as unknown as FaqTranslator, locale)
                ...
                <h3>
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (!isOpen) track("faq_opened", { question: item.id })
                    }}
