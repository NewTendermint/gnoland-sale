 ...
 * headless hooks.
 *
 * Chain pinning is locked to Ethereum mainnet (prod) + Sepolia (preview) only; never
...
// Chain the wrong-network gate switches to. Ethereum mainnet in prod; preview can override.
