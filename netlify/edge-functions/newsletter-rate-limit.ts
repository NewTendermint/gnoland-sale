...
/**
 * Edge cap for the newsletter subscribe write - the 5th unauthenticated write, aligned with its
 * peers (permit/auth-init/push-subscribe). The route keeps its own per-instance in-memory window
