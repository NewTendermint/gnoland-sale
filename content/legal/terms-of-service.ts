// VERBATIM Terms of Service (team, 2026-06-30). Do NOT reword/retitle/restructure.
// Mechanical edits only: escape backslashes dropped, en/em-dashes -> hyphens.
// Section 10 anchors to #risk-disclosures (footer "Risk Disclosure" link).
export const termsOfServiceMarkdown = `**1. Introduction**
...
9.1. **Informational Purposes Only:** Any data or information available through the Services is provided purely for general information. We do not warrant that any such information is accurate, complete, or up-to-date. No content available on the Services is intended to be or should be taken as professional advice (investment, financial, legal, or otherwise). Before making decisions regarding buying, selling, or holding digital assets, you should conduct your own due diligence and consult advisors where appropriate.

9.2. **No Advisory Relationship:** Your use of the Services does not create any advisory, fiduciary, or professional relationship between you and the Company. We are not your broker, dealer, investment advisor, or legal advisor, and we owe you no fiduciary duties. Any decisions you make using the Services, such as participating in governance, deploying or interacting with a smart contract, or transacting with digital assets, are made at your sole discretion and risk. You are solely responsible for evaluating the merits and risks of any transaction or action.

9.3. **User Responsibility:** You acknowledge that digital assets and blockchain projects are risky and volatile. You should not interpret any content, communication, or functionality of the Services as a recommendation or endorsement of any investment or project. “Do Your Own Research (DYOR)” is critical. Always carefully consider your financial situation and risk tolerance before engaging in any blockchain or cryptocurrency-related activities.

9.4. **No Client Relationship:** Unless you have a separate, formal, written agreement with us for advisory or consulting services, we are not liable for any use you make of information obtained through the Services. There is no client-professional relationship here. You are simply using a software service.
...
1. THE TOTAL AMOUNT OF FEES, IF ANY, YOU PAID TO US FOR USE OF THE SERVICES IN THE TWELVE MONTHS IMMEDIATELY PRIOR TO THE EVENT GIVING RISE TO THE CLAIM; OR
...
14.2. **Termination by You:** You may stop using the Services at any time. If you wish to terminate your agreement with these Terms, you may do so simply by discontinuing use of all Services. Keep in mind that if you stop using the Services, any content you posted on the Network will remain on-chain as we cannot remove on-chain data.

14.3. **Termination by Company:** We reserve the right to suspend or terminate your access to the Services under our control, in whole or in part, at our sole discretion, immediately and without prior notice, if we suspect or determine that:
...
15.8. **Class Action and Jury Trial Waiver:** You and the Company agree that all Disputes will be resolved only on an individual basis, and not as a class, consolidated, or representative action. You waive any right to a jury trial or to participate in a class action against the Company.

15.8.1. **No Class Arbitrations or Actions:** The arbitrator may not consolidate or join the claims of other individuals or parties in a similar situation, and may not preside over any form of a representative or class proceeding. Each party agrees to arbitration only on an individual basis.

15.8.2. **If Class Waiver is Unenforceable:** If a court decides that applicable law precludes enforcement of any of this subsection’s limitations as to a particular claim or request for relief and all appeals are exhausted or not taken, then you and we agree that such claim or request for relief, and only that claim or request, will proceed in a court of competent jurisdiction, but the class action and jury waiver shall still apply to the fullest extent allowed. You and the Company agree to waive any right to a jury trial for any such court proceeding. Furthermore, in such an event, you agree to bring any claim only in the state or federal courts located in the State of Delaware, and you consent to the personal jurisdiction of those courts.

15.9. **Severability of Arbitration Provisions:** If any portion of this Section 15 is found to be unenforceable or unlawful for a particular dispute, then the unenforceable portion shall be severed and the remainder of this Section shall still apply. In the event that the entirety of this arbitration agreement is found unenforceable for a dispute, you and the Company agree that the exclusive jurisdiction and venue described in Section 18.11 shall govern any court proceedings.
...
1. copy, reproduce, distribute, modify, or create derivative works of the Services or any part thereof;

2. reverse engineer, decompile, or attempt to extract the source code of any proprietary component of the Services, except to the extent such activity is expressly permitted by applicable open-source licenses or law notwithstanding this limitation; or

3. use any of the Company’s names, logos, or trademarks without our prior written consent.
...
Attn: DMCA Agent - NewTendermint Legal

Carolyn Pehrson, ACP (Registration #153281)

25876 The Old Rd #41,

Stevenson Ranch, CA 91381, USA

Email: legal@newtendermint.org
...
1. **Identification of the work claimed to be infringed:** A description of the copyrighted work that you claim has been infringed. If multiple copyrighted works are covered in one notice, you can provide a representative list.

2. **Identification of the material infringing your copyright:** A description of the material that is claimed to be infringing or to be the subject of infringing activity, and information reasonably sufficient to locate the material. Please provide the precise location (e.g., a URL or realm address or specific transaction hash) of the allegedly infringing content.

3. **Your contact information:** Information reasonably sufficient to permit us to contact you, such as an address, telephone number, and an email address.

4. **A statement of good faith, accuracy and authority:** A statement that you have a good-faith belief that use of the material in the manner complained of is not authorized by the copyright owner, its agent, or the law. Additionally, include a statement that the information in your notice is accurate, and under penalty of perjury, that you are the owner of the copyright (or authorized to act on behalf of the owner).
...
1. Identification of the material that has been removed or to which access has been disabled, and the location (URL, etc.) at which the material appeared before removal.
...
18.11. **Jurisdiction and Venue:** Subject to the dispute resolution provisions above, you agree that any judicial proceedings, in cases where arbitration is not required or is found unenforceable, will be brought in, and you consent to the exclusive jurisdiction of, the state and federal courts located within the State of Delaware, USA. You waive any objection to jurisdiction and venue in such courts. You also agree to waive any right to a trial by jury in any such proceeding.

18.12. **No Oral Modifications:** You agree that you will not rely on any oral statements or representations regarding the content of these Terms. These Terms may only be amended as provided herein, through a written, published modification or an agreement signed by an authorized representative of the Company.

18.13. **Export Controls and Sanctions:** You may not use, export, re-export, import, or transfer any part of the Services except as authorized by United States law, the laws of the jurisdiction in which you use the Services, and any other applicable laws. In particular, but without limitation, the Services, and any related software or technical information you obtain from us, may not be exported or re-exported:

1. into any U.S.-embargoed country or to anyone on any U.S. government restricted list, such as the Specially Designated Nationals list; or

2. for any purpose prohibited by export control laws, including nuclear, chemical, or biological weapons proliferation.
...
18.14. **Language:** These Terms are written in English. If these Terms are translated into another language, the English version shall prevail to the extent of any inconsistency or ambiguity between the English version and a translated version.

18.15. **Headings and Interpretation:** Section titles and headings in these Terms are for convenience only and have no legal or contractual effect. In these Terms, the words “including” and “include” mean “including, but not limited to.” Any examples given are illustrative and not the sole possible instances of a concept.

18.16. **Consent to Electronic Agreement:** Your acceptance of these Terms, and any other agreements referenced herein, occurs electronically, such as by your use of the Services or by a prompt asking for agreement. You agree that such electronic acceptance has the same force and effect as a physical signature.`
