// VERBATIM Privacy Policy (team, 2026-06-30). Do NOT reword/retitle/restructure.
// Mechanical edits only: escape backslashes + SWDocID stamp dropped, en-dashes -> hyphens.
export const privacyPolicyMarkdown = `Gno.land, hosted by NewTendermint, LLC (“NewTendermint”, “we”, “us,” or “our”), provides Gno.land which is the next generation of smart contract platforms. Gno.land is the central repository of the ecosystem, with realms built using fully transparent, auditable code that anyone can inspect and reuse.

**1. Scope and Updates to this Privacy Policy**

This Privacy Policy applies to personal information processed by us in connection with Gno.land, or wherever this Privacy Policy is linked. By accessing or using Gno.land, you signify that you have read, understood, and agree to the [Gno.land Terms and Conditions](/terms-of-service) and to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy. You also acknowledge that once your personal information has been entered, you may no longer be able to access, delete, or modify the personal information you have provided.
