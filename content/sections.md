...
**U.S. Investor Disclaimer** (verbatim, provided by the team 2026-06-26; rendered on the dedicated page `/us-investor-disclaimer`, linked from the footer; mirrored 1:1 into `content/sections/legal.ts` - do NOT reword, retitle, or restructure):

> The Tokens have not been registered under the United States Securities Act of 1933, as amended, or any U.S. state securities laws, and are offered outside the United States in reliance on Regulation S. The Tokens may not be offered, sold, delivered, transferred, assigned, pledged, or otherwise disposed of in the United States or to, or for the account or benefit of, any U.S. person, except pursuant to an available exemption from registration and in compliance with applicable law.
>
> U.S. persons may participate only with the Issuer’s express prior approval in a private placement under Rule 506 of Regulation D, upon evidence satisfactory to the Issuer of accredited investor status and eligibility. The Issuer may, in its sole discretion, reject, suspend, cancel, unwind, freeze, or refuse any purchase, acquisition, holding, use, access, or transfer for legal, regulatory, compliance, or other reasons.
>
> The Tokens may be deemed securities or other regulated instruments, and no representation or warranty is made that any exemption or regulatory treatment will be available. Any non-compliant offer, sale, acquisition, or transfer may result in restrictions, loss of rights, rescission claims, penalties, enforcement action, or other adverse consequences.
>
> Nothing on this website or in related materials constitutes legal, tax, accounting, investment, financial, or other professional advice, or any offer, solicitation, recommendation, or invitation to purchase, acquire, hold, use, or transfer any Token. Each participant is solely responsible for determining the legality, suitability, and consequences of participation and should consult its own advisers.
>
> By accessing this website or acquiring, holding, using, or transferring any Token, each person represents, warrants, acknowledges, and agrees that such person is not located in the United States and is not a U.S. person, unless expressly approved by the Issuer under an available exemption; if so approved, such person is an accredited investor; such person assumes the risk of total loss; and no transfer shall occur except in accordance with applicable law and Issuer restrictions.
>
> The Issuer may implement geoblocking, wallet screening, KYC/AML procedures, sanctions screening, investor verification, holding periods, legends, transfer controls, and other compliance measures, and may restrict, suspend, terminate, or cancel access or participation at any time without liability.
>
> Participation involves substantial risk, including total loss, limited or no liquidity, volatility, operational, technological, cybersecurity, smart-contract, protocol, tax, legal, regulatory, and enforcement risks. Persons located in the United States, U.S. persons, and persons who do not satisfy all eligibility requirements must not access, purchase, acquire, hold, use, or transfer the Tokens.
