...
export const sceneVideos = {
  hero: {
    ...
    poster: "/sprites/vault-spin-2s.poster.jpg?v=9",
    innerDelayMs: 1100,
  },
  narrativeA: {
    sources: [
    ...
    poster: "/sprites/village-spin-2s.poster.jpg?v=9",
  },
  narrativeB: {
    sources: [
    ...
    poster: "/sprites/village-macro-2s.poster.jpg?v=9",
  },
  features: {
    sources: [
    ...
    poster: "/sprites/mine-spin-2s.poster.jpg?v=9",
  },
  gnotUtility: {
    sources: [
    ...
    poster: "/sprites/bridge-spin-2s.poster.jpg?v=9",
  },
  partnersA: {
    sources: [
    ...
    poster: "/sprites/tree-spin-cubic.poster.jpg?v=9",
  },
  partnersB: {
    sources: [
