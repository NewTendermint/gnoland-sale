...
/**
 * Per-bidder outcome at settlement. Binary fill (no per-commitment fill field in the SDK):
 * a marginal winner pro-rata filled on-chain can carry a partial refund this reports as
 * zero; claimRefund() refunds the true amount regardless, but the user is not prompted.
